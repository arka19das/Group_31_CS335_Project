...
def p_postfix_expression_3(p):
    ...
    if len(p) == 2:
        ...
        if p[1].type.endswith("*"):
            ...
            activation_record.append(["long=", p[1].place + offset_string, tmp_var+tmp_offset_string])
...
def p_unary_expression(p):
    ...
    if len(p) == 2:
        ...
        if p[1].val == "++" or p[1].val == "--":
            ...
            activation_record.append(["int=", tmp_var+tmp_offset_string, type_size])
            ...
            if p[2].type.upper() not in TYPE_CHAR + TYPE_INTEGER:
                ...
                activation_record.append(["int=", tmp_var+tmp_offset_string, "1", ""])
                activation_record.append(["goto", "", "", label2])
                activation_record.append(["label", label1, ":", ""])
                activation_record.append(["int=", tmp_var+tmp_offset_string, "0", ""])
        ...
        activation_record.append(["int=", tmp_var+tmp_offset_string, str(type_size)])
